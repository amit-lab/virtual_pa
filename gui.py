...
class Gui(Tk):
    ...
    def nlp_page(self):
        ...
        info_label = Label(nlp_win, text="Insert what you wand in search box \n\
        or press mic btn and speak", fg='green', bg='white')
    ...
    def voice_command_page(self):
        voice_win = Tk()
        voice_win.title("Voice Command")
